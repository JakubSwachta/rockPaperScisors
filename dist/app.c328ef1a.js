...
//zmienne
var userScore = 0;
var computerScore = 0; //DOM zmienne
...
var scissors_div = document.getElementById("s"); //function computer choice, create an array, asign random 1,2,3 to our r,p,s id
...
var convertToWord = function convertToWord(letter) {
...
var win = function win(userChoice, ComputerChoice) {
  ...
  result_p.innerHTML = "".concat(convertToWord(userChoice)).concat(smallUserWord, " \n  beats ").concat(convertToWord(ComputerChoice)).concat(smallCompWord, " YOU WIN!\uD83D\uDD25");
...
var lose = function lose(userChoice, ComputerChoice) {
  ...
  userScore_span.innerHTML = userScore;
  computerScore_span.innerHTML = computerScore;
  result_p.innerHTML = "".concat(convertToWord(userChoice)).concat(smallUserWord, " \n  loses to ").concat(convertToWord(ComputerChoice)).concat(smallCompWord, " YOU LOST...\uD83D\uDCA9");
...
var draw = function draw(userChoice, ComputerChoice) {
  ...
  var smallCompWord = "comp".fontsize(3).sub();
  var userChoice_div = document.getElementById(userChoice);
  result_p.innerHTML = "".concat(convertToWord(userChoice)).concat(smallUserWord, " \n  equals ").concat(convertToWord(ComputerChoice)).concat(smallCompWord, " it's a draw \uD83E\uDD71");
